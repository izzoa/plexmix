        ...
        rx.vstack(
            ...
            rx.cond(
                ...
                rx.vstack(
                    ...
                    rx.text("Model Name", size="3", weight="bold", margin_top="2"),
                    rx.input(
                    ...
                    rx.text("API Key (optional)", size="3", weight="bold", margin_top="2"),
                    rx.input(
                        type="password",
        ...
        rx.vstack(
            ...
            rx.cond(
                ...
                rx.vstack(
                    ...
                    rx.text("Embedding Dimension", size="3", weight="bold", margin_top="2"),
                    rx.input(
                        type="number",
                    ...
                    rx.text("Must match the output dimension of your model", size="1", color_scheme="gray"),
                    spacing="2",
                    width="100%",
                ),
                rx.cond(
