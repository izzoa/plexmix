            ...
            rx.hstack(
                rx.link(
                    rx.button(
                        ...
                        title=rx.cond(
                            ~(DashboardState.plex_configured & DashboardState.ai_provider_configured),
                            "Configure Plex and AI provider first",
                            "",
                        ),
                    ),
                    href="/generator",
                ...
                rx.link(
                    rx.button(
                        ...
                        title=rx.cond(~DashboardState.plex_configured, "Configure Plex first", ""),
                    ),
                    href="/library",
                ),
                spacing="4",
